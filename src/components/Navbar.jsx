...
export default function Navbar({ onOpenQuote }) {
  ...
  return <header className="site-header"><div className="nav-inner">
    <Link to="/" className="brand" onClick={() => setOpen(false)}><img src="/images/logo/logo.jpg" alt="SSPR Valve"/><span><strong>SSPR Valve Manufacturing Private Limited</strong><small>FLOWING A STRONGER TOMORROW</small></span></Link>
    ...
    <button className="button-orange nav-enquiry" onClick={onOpenQuote}><Send size={17}/><span>Send Enquiry</span></button>
