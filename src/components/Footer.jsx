...
export default function Footer() {
 ...
 return <footer className="site-footer"><div className="footer-grid">
  <div className="footer-brand"><Link to="/"><img src="/images/logo/logo.jpg" alt="SSPR Valve"/></Link><strong>SSPR Valve Manufacturing Private Limited</strong><small>FLOWING A STRONGER TOMORROW</small></div>
