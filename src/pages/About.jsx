      ...
      <section className="about-intro-section py-5 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 items-center">
            ...
            <FadeIn direction="left" className="about-office-gallery lg:col-span-6">
      ...
      <section className="py-5 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <StaggerContainer className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            {/* Mission */}
            <StaggerItem hoverEffect={true} className="bg-slate-50 rounded-md p-6 border border-slate-200 shadow-2xs hover:shadow-sm transition-all flex flex-col">
