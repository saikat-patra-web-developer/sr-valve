    ...
    <div className="site-page page-products">
      ...
      <section className="py-12 sm:py-16 bg-slate-50/70">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <FadeIn direction="up" className="flex flex-col sm:flex-row sm:items-center justify-between mb-3 pb-3 border-b border-slate-200 gap-2">
            <div>
          ...
          <StaggerContainer className="grid lg:grid-cols-2 gap-6">
            {productsData.map((product) => (
              <StaggerItem key={product.id} hoverEffect={true} as="div">
                <article className="group bg-white rounded-2xl border border-slate-200 overflow-hidden shadow-sm hover:shadow-xl hover:border-blue-200 transition-all duration-300 flex flex-col sm:flex-row min-w-0 h-full">
                  ...
                  <div className="p-5 sm:p-6 flex flex-col flex-1 min-w-0">
                    ...
                    <motion.div whileHover={{ y: -2 }} whileTap={{ scale: 0.97 }} className="mt-5">
                      <Link to={`/products/${product.id}`} className="inline-flex w-full items-center justify-center gap-2 bg-[#0d2857] hover:bg-[#f37021] text-white font-bold px-5 py-3 rounded-lg transition-colors text-sm">
      ...
      <FadeIn direction="up" as="section" className="bg-gradient-to-r from-[#0d2857] via-[#123674] to-[#0d2857] text-white py-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
